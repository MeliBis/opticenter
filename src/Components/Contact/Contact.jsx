...
const Contact = () => {
  return (
    <section className="showcase">
      <h2 className="text-center margin mb-3 fw-bold">Contáctame</h2>
      <h4 className="text-center mb-5">Descubre el mundo con claridad</h4>

      <div className="container-fluid p-0">
        <div className="row g-0">
          <div className="col-lg-6 order-lg-2 text-white showcase-img firs-section-img" />
        ...
        <div className="row g-0">
          <div className="col-lg-6 text-white showcase-img second-section-img" />
          ...
          <div className="col-lg-6 my-auto showcase-text">
            ...
            <div className="">
              <ul className="d-flex list-unstyled ">
                <li className="contact-link">
                  <Link
                    to="https://wa.me/7971415421?text=Hola,%20necesito%20agendar%20una%20mi%20cita"
                    target={"blank"}
                    className="text-reset"
                  >
                    <svg
        ...
        <div className="row g-0">
          <div className="col-lg-6 order-lg-2 text-white showcase-img third-section-img" />
          <div className="col-lg-6 order-lg-1 my-auto showcase-text">
